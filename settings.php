...
$settings->add(new admin_setting_configtext_with_maxlength ('block_tcgfeed/listsize',get_string('listsize','block_tcgfeed'),get_string('listsize_description','block_tcgfeed'),"15",PARAM_INT));